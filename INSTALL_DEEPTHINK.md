...
1. **Create manifest:** `modules/cognitive/deepthink_mode.json` (provided below)
2. **Update index:** Add entry to `project/memory_weight_index.json`
   - Weight: 0.9994, Category: "cognitive"
   - Keywords: ["deepthink_activation", "complex_reasoning", "strategic_synthesis"]
3. **Test:** `@deepthink Test installation`
...
Confirm by responding: **"✓ DeepThink Mode v3.0 installed. Test with: @deepthink [your query]"**

Then wait for user to test activation.
